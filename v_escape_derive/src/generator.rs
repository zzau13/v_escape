...
pub fn generate(pairs: &[Pair], sized: bool, simd: bool, avx: bool, sse: bool) -> String {
    Generator::new(pairs, sized, simd, avx, sse).build()
}
...
mod test {
    ...
    fn test_1_escape() {
        ...
        let g = Generator::new(pairs, false, false, false, false);
