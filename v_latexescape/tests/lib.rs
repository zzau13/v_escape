...
mod string {
    ...
    fn tests() {
        ...
        assert_eq!(result(["fo", escapes].join("").as_ref()), ["fo", escaped].join(""));
        assert_eq!(
            result(["fo", escapes, "b"].join("").as_ref()), ["fo", escaped, "b"].join("")
        );
        ...
        assert_eq!(
            result(["fo", & escapes.repeat(2)].join("").as_ref()), ["fo", & escaped
            .repeat(2)].join("")
        );
        assert_eq!(
            result(["fo", & escapes.repeat(2), "bar"].join("").as_ref()), ["fo", &
            escaped.repeat(2), "bar"].join("")
        );
        assert_eq!(
            result(["fo", & escapes.repeat(3), "bar"].join("").as_ref()), ["fo", &
